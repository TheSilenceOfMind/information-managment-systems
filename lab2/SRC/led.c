...
/*  
Чем больше порядковый номер в массиве, тем больше яркость тeх диодов, которые задаются маской - элементом массива
...
Например, если в нулевом элементе массива лежит значение 00110011, то диоды под номерами 1,2,5,6 будут светиться
с яркостью в 0 процентов, то бишь не будут светиться
*/
