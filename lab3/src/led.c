...
/**----------------------------------------------------------------------------
                            readdip
-------------------------------------------------------------------------------
Считывает значение с DIP-переключателей

Вход:       нет
Выход:      8-битное значение с переключателей
Результат:  нет
Описание:   
Пример:
-----------------------------------------------------------------------------*/
...
{
	write_max( (unsigned char __xdata *)ENA, 0x00 ); // Входим в режим чтения
    return read_max( (unsigned char __xdata *)EXT_LO ); // Считываем значения DIP-переключателей
}
